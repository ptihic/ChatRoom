...
/***/ function(module, exports, __webpack_require__) {
	...
	var VueResource = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tools = __webpack_require__(1);
	module.exports = {
	  valid: function valid(app, success, error) {
	...
	module.exports = {
	  data: function data() {
	    return {
	      friendId: 2,
	      friendName: 'friend',
	      image1: __webpack_require__(9),
	      image2: __webpack_require__(8),
	      newTodo: "",
	      IUserId: 1,
	      IUserName: 'me',
	      postMsgList: [{
	  ...
	  methods: {
	    addTodo: function addTodo() {
	      ...
	      if (text) {
	        $this.$http.post(tools.resolveUrl("/"), {
	          userId: $this.IUserId,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "2.png?1be01fd3ca7da2fd8a21486ef9400f09";

/***/ },
/* 9 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "3.png?8ad8b0f2b88022b051e7887ab6f354e3";
...
/***/ function(module, exports) {
	...
	module.exports = "\n  <div class=\"am-container\">\n    <div class=\"am-g\">\n      <div class=\"am-u-sm-11 am-u-md-8 am-u-lg-5 am-u-sm-centered\">\n      <h1>\n      欢迎加入聊天室\n      </h1>\n      <form class=\"am-form\" data-am-validator=\"true\" id=\"new_user\" action=\"/users\" accept-charset=\"UTF-8\" method=\"post\" novalidate=\"novalidate\"><input name=\"utf8\" type=\"hidden\" value=\"✓\"><input type=\"hidden\" name=\"authenticity_token\" value=\"k2nJX40VUZxdDCoIg5/I6/+flPecnIeeJl2eohmXDCvsgRVl8dbM41A3H+muTi6nFWtPtwWz/50W+4T5Q0G/AA==\">\n      <div class=\"am-form-group\">\n      <label for=\"user_email\">邮箱</label>\n      <input class=\"am-radius\" required=\"required\" type=\"email\" name=\"user[email]\" id=\"user_email\" pattern=\"^((([a-zA-Z]|\\d|[!#\\$%&amp;'\\*\\+\\-\\/=\\?\\^_`{\\|}~]|[\\u00A0-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF])+(\\.([a-zA-Z]|\\d|[!#\\$%&amp;'\\*\\+\\-\\/=\\?\\^_`{\\|}~]|[\\u00A0-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF])+)*)|((\\x22)((((\\x20|\\x09)*(\\x0d\\x0a))?(\\x20|\\x09)+)?(([\\x01-\\x08\\x0b\\x0c\\x0e-\\x1f\\x7f]|\\x21|[\\x23-\\x5b]|[\\x5d-\\x7e]|[\\u00A0-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF])|(\\\\([\\x01-\\x09\\x0b\\x0c\\x0d-\\x7f]|[\\u00A0-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF]))))*(((\\x20|\\x09)*(\\x0d\\x0a))?(\\x20|\\x09)+)?(\\x22)))@((([a-zA-Z]|\\d|[\\u00A0-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF])|(([a-zA-Z]|\\d|[\\u00A0-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF])([a-zA-Z]|\\d|-|\\.|_|~|[\\u00A0-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF])*([a-zA-Z]|\\d|[\\u00A0-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF])))\\.)+(([a-zA-Z]|[\\u00A0-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF])|(([a-zA-Z]|[\\u00A0-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF])([a-zA-Z]|\\d|-|\\.|_|~|[\\u00A0-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF])*([a-zA-Z]|[\\u00A0-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFEF])))\\.?$\">\n      <p class=\"am-form-help\">此邮箱将作为您的登陆账号</p>\n      </div>\n      <div class=\"am-form-group\">\n      <label for=\"user_password\">密码</label>\n      <input class=\"am-radius\" required=\"required\" type=\"password\" name=\"user[password]\" id=\"user_password\">\n      <p class=\"am-form-help\">请使用 8-16 位，由大写字母、小写字母、阿拉伯数字和特殊符号中至少 3 种组合而成的密码</p>\n      </div>\n      <div class=\"am-form-group\">\n      <label for=\"user_password_confirmation\">确认密码</label>\n      <input class=\"am-radius\" required=\"required\" type=\"password\" name=\"user[password_confirmation]\" id=\"user_password_confirmation\">\n      </div>\n      <!-- <hr>\n      <p class=\"am-text-sm\">\n      点击“注册帐号”按钮，表示您了解并同意我们的<a target=\"_blank\" href=\"/help/articles/115198\">服务条款</a>\n      </p>\n      <hr> -->\n      <div class=\"am-form-group\">\n      <input type=\"submit\" name=\"commit\" value=\"注册帐号\" class=\"am-btn am-btn-block am-btn-success am-radius\">\n      </div>\n      </form>\n      </div>\n    </div>\n  </div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __vue_script__, __vue_template__
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"-!./../../node_modules/extract-text-webpack-plugin/loader.js?{\"remove\":true}!css!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-50bcc37b&file=index.vue!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./index.vue\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
	__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"-!./../../node_modules/extract-text-webpack-plugin/loader.js?{\"remove\":true}!css!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-50bcc37b&file=index.vue!less!./../../node_modules/vue-loader/lib/selector.js?type=style&index=1!./index.vue\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
...
/***/ function(module, exports, __webpack_require__) {
	...
	function install(Vue) {
	    ...
	    var _ = __webpack_require__(23)(Vue);
